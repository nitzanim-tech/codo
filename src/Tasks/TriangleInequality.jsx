  ...
  return (
    <>
      <p>
        ...
        <br />
        כתבו תכנית המקבלת 3 אורכים של צלעות b, a ו-c, וקובעת האם ניתן לבנות מהן משולש.
      </p>
    </>
  );
}
  ...
  return (
    <>
      <p style={{ textAlign: 'left', dir: 'rtl' }}>
        <code>
          Please enter A side: <b>3</b>
          <br />
          Please enter B side: <b>4</b>
          <br />
          Please enter C side: <b>7</b>
          <br />
